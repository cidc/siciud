...
<%  Connection conn = null;
         String formato = "";
         String idFACULTAD = request.getParameter("txtidfacultad4");
         String idDURACION= request.getParameter("txtidtempo");
         ...
         try
         {
            ...
            File reportFile = new File(application.getRealPath("REPORTES/REPORTFOUR.jasper"));
            Map parameters = new HashMap();

            int Opcion = Integer.parseInt(request.getParameter("txtidformato3"));
            ...
            parameters.put("FACULTAD", Integer.parseInt(idFACULTAD));
            parameters.put("DURACION", Integer.parseInt(idDURACION));
