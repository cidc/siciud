...
public final class Criterios_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tif(formulario.criterios_.length){\r\n");
      out.write("\t\t\tfor(var i=0;i<formulario.criterios_.length;i++){\r\n");
      out.write("\t\t\t\tif(formulario.criterios_[i].checked==false){\r\n");
      out.write("\t\t\t\t\tformulario.criterios[i].disabled=true;\r\n");
      out.write("\t\t\t\t\tformulario.critValor[i].disabled=true;\r\n");
      out.write("\t\t\t\t\tformulario.critValor[i].value=\"\";\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\tformulario.criterios[i].disabled=false;\r\n");
      out.write("\t\t\t\t\tformulario.critValor[i].disabled=false;\r\n");
      out.write("\t\t\t\t\tif(formulario.critValor[i].value==\"\"){\r\n");
      out.write("\t\t\t\t\t\tformulario.critValor[i].value=\"0\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\tvar por=0;\r\n");
      out.write("\t\tfor(var i=0;i<formulario.criterios_.length;i++){\r\n");
      out.write("\t\t\tif(formulario.criterios_[i].checked==true){\r\n");
      out.write("\t\t\t\tpor=parseFloat(formulario.critValor[i].value)+por;\r\n");
      out.write("\t\t\t\tdocument.getElementById('total').innerHTML=por;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(por>100){\r\n");
      out.write("\t\t\talert(\"La sumatoria no puede superar el 100%\");\r\n");
      out.write("\t\t\tcaja.value=\"0\";\r\n");
      out.write("\t\t\tsumar(formulario);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction chequear(formulario1,formulario2){\r\n");
      out.write("\t\tfor(var i=0;i<formulario1.criterios.length;i++){\r\n");
      out.write("\t\t\tformulario1.critValor[i].disabled=true;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(formulario2.critInc){\r\n");
      out.write("\t\t\tif(formulario2.critInc.length){\r\n");
      out.write("\t\t\t\tfor(var i=0;i<formulario1.criterios.length;i++){\r\n");
      out.write("\t\t\t\t\tformulario1.critValor[i].disabled=true;\r\n");
      out.write("\t\t\t\t\tfor(var j=0;j<formulario2.critInc.length;j++){\r\n");
      out.write("\t\t\t\t\t\tif(formulario2.critInc[j].value==formulario1.criterios[i].value){\r\n");
      out.write("\t\t\t\t\t\t\tformulario1.criterios_[i].checked=true;\r\n");
      out.write("\t\t\t\t\t\t\tformulario1.critValor[i].disabled=false;\r\n");
      out.write("\t\t\t\t\t\t\tformulario1.critValor[i].value=formulario2.valor[j].value;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\tfor(var i=0;i<formulario1.criterios.length;i++){\r\n");
      out.write("\t\t\t\t\t\tformulario1.critValor[i].disabled=true;\r\n");
      out.write("\t\t\t\t\t\tif(formulario2.critInc.value==formulario1.criterios[i].value){\r\n");
      out.write("\t\t\t\t\t\t\tformulario1.criterios_[i].checked=true;\r\n");
      out.write("\t\t\t\t\t\t\tformulario1.critValor[i].disabled=false;\r\n");
      out.write("\t\t\t\t\t\t\tformulario1.critValor[i].value=formulario2.valor.value;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\tchecks(document.frmCriterios);\r\n");
      out.write("\t\t\tdocument.frmCriterios.action='");
      if (_jspx_meth_c_005furl_005f0(_jspx_page_context))
        return;
      out.write("';\r\n");
      out.write("\t\t\tdocument.frmCriterios.submit();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction ValidarFormulario(){\r\n");
      out.write("\t\tvar total=parseInt(document.getElementById('total').innerHTML);\r\n");
      out.write("\t\tif(total<100){\r\n");
      out.write("\t\t\talert(\"No se ha completado el 100%\");\r\n");
      ...
      out.write("\t\t\t<div style=\"width:670px;height:180px;overflow:auto;vertical-align:top;background-color:#ffffff;\">\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("</body>\r\n");
      out.write("<script>\r\n");
      out.write("\tchequear(document.frmCriterios,document.frmInsc);\r\n");
      out.write("\tsumar(document.frmCriterios);\r\n");
      out.write("</script>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_c_005fimport_005f0(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(8,0) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f0(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(89,33) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fimport_005f1(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(108,4) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f1(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(115,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f2(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(116,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f3(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(120,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f4(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(121,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f5(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(125,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f6(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(126,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f7(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(130,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f8(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(131,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f9(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(135,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f10(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(136,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f11(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(140,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f12(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(141,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f13(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(145,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f14(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(146,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f15(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(150,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f16(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(151,26) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f17(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(155,41) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f18(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(156,61) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(163,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t</table>\r\n");
        out.write("\t<br>\r\n");
        out.write("\t<form name=\"frmCriterios\" method=\"post\">\r\n");
        out.write("\t\t<input type=\"hidden\" name=\"accion\" value='7'>\r\n");
        out.write("\t\t<input type=\"hidden\" name=\"de\" value='3'>\r\n");
        out.write("\t\t<input type=\"hidden\" name=\"irA\" value=\"3\">\r\n");
        out.write("\t\t<div align=\"center\">\r\n");
        out.write("\t\t<fieldset style=\"width:430px;\">\r\n");
        out.write("            <legend><b>Criterios</b></legend>\r\n");
        out.write("              <table class=\"tablas\" width=\"100%\" align=\"left\">\r\n");
        out.write("              \t\t<tr>\r\n");
        out.write("              \t\t\t<td class=\"renglones\" colspan=\"2\">&nbsp;</td>\r\n");
        out.write("\t\t\t\t\t\t<td class=\"renglones\" colspan=\"2\"><b>Nombre Criterio</b></td>\r\n");
        out.write("\t\t\t\t\t\t<td class=\"renglones\" colspan=\"2\"><b>Valor</b></td>\r\n");
        out.write("\t\t\t\t\t</tr>\r\n");
        out.write("\t\t\t\t\t");
        ...
        out.write("\t\t\t\t\t<td align=\"left\"><b>%</b></td>\r\n");
        out.write("\t\t\t\t\t</tr>\r\n");
        out.write("\t\t\t\t<tr>\r\n");
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(166,38) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(166,97) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(167,22) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(184,5) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setBegin(0);
    // /Convocatoria/Criterios.jsp(184,5) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /Convocatoria/Criterios.jsp(184,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("lista");
    // /Convocatoria/Criterios.jsp(184,5) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          if (_jspx_meth_c_005fout_005f3(_jspx_th_c_005fforEach_005f0, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f0))
            return true;
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t \t<td><input type=\"checkbox\" name=\"criterios_\" onchange=\"checks(document.frmCriterios)\"><td>\r\n");
          out.write("\t\t\t\t\t\t\t<td>");
          if (_jspx_meth_c_005fout_005f4(_jspx_th_c_005fforEach_005f0, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f0))
            return true;
          out.write("</td>\r\n");
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t<td style=\"width:30px;\"><input type=\"text\" name=\"critValor\" size=\"4\" maxlength=\"5\" onKeyPress='return soloNumeros(event)' onkeyup=\"sumar(document.frmCriterios,this)\"></td>\r\n");
          out.write("\t\t\t\t\t\t\t<td align=\"left\"><b>%</b>\r\n");
  ...
  private boolean _jspx_meth_c_005fout_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /Convocatoria/Criterios.jsp(186,11) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /Convocatoria/Criterios.jsp(188,11) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f4.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${lista.nombre}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fout_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /Convocatoria/Criterios.jsp(192,53) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f19(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(230,34) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(237,2) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setBegin(0);
    // /Convocatoria/Criterios.jsp(237,2) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.ListaCritInscOBJ}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    // /Convocatoria/Criterios.jsp(237,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("lista");
    // /Convocatoria/Criterios.jsp(237,2) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t<input type=\"hidden\" name=\"critInc\" value='");
  ...
  private boolean _jspx_meth_c_005fout_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /Convocatoria/Criterios.jsp(238,46) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /Convocatoria/Criterios.jsp(239,44) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f7.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${lista.valor}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /Convocatoria/Criterios.jsp(244,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
