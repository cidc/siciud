...
public class Crear extends ServletGeneral {
	...
	public String[] operaciones(HttpServletRequest req, HttpServletResponse resp)
		...
		case ParametrosOBJ.GuardarReq:
			...
			if (sesion.getAttribute("convocatoriaOBJ") != null) {
				if (convocatoriasDB.nuevoRequisitoDoc((ConvocatoriaOBJ) sesion
						.getAttribute("convocatoriaOBJ")))
		...
		case ParametrosOBJ.GuardarRub:
			...
			if (sesion.getAttribute("convocatoriaOBJ") != null) {
				if (convocatoriasDB.nuevoRubro((ConvocatoriaOBJ) sesion
						.getAttribute("convocatoriaOBJ")))
					mensaje = "Registro insertado Correctamente";
				else
					mensaje = "El registro no puede ser insertado";
		...
		case ParametrosOBJ.GuardarCom:
			System.out.println("entra al guardarRub");
			if (sesion.getAttribute("convocatoriaOBJ") != null) {
				if (convocatoriasDB.nuevoCompromiso((ConvocatoriaOBJ) sesion
						.getAttribute("convocatoriaOBJ")))
					mensaje = "Registro insertado Correctamente";
				else
					mensaje = "El registro no puede ser insertado";
		...
		case ParametrosOBJ.GuardarCrit:
			...
			if (sesion.getAttribute("convocatoriaOBJ") != null) {
				if (convocatoriasDB.nuevoCriterio((ConvocatoriaOBJ) sesion
						.getAttribute("convocatoriaOBJ")))
					mensaje = "Registro insertado Correctamente";
				else
					mensaje = "El registro no puede ser insertado";
		...
		case ParametrosOBJ.GuardarAsp:
			...
			if (sesion.getAttribute("convocatoriaOBJ") != null) {
				if (convocatoriasDB.nuevoAspecto((ConvocatoriaOBJ) sesion
						.getAttribute("convocatoriaOBJ")))
					mensaje = "Registro insertado Correctamente";
				else
					mensaje = "El registro no puede ser insertado";
		...
		case ParametrosOBJ.GuardarEje:
			...
			if (sesion.getAttribute("convocatoriaOBJ") != null) {
				if (convocatoriasDB.nuevoEje((ConvocatoriaOBJ) sesion
						.getAttribute("convocatoriaOBJ")))
					mensaje = "Registro insertado Correctamente";
				else
					mensaje = "El registro no puede ser insertado";
		...
		case ParametrosOBJ.ModificarReq:
			...
			if (convocatoriasDB.modificaRequisitoDoc((ConvocatoriaOBJ) sesion
					.getAttribute("convocatoriaOBJ")))
		...
		case ParametrosOBJ.ModificarRub:
			irA = "/Convocatoria/AdmRubros.jsp";
			if (convocatoriasDB.modificaRubro((ConvocatoriaOBJ) sesion
					.getAttribute("convocatoriaOBJ")))
				mensaje = "Documento Actualizado Correctamente";
			else
				mensaje = "El Documento no pude ser actualizado";
		...
		case ParametrosOBJ.ModificarCom:
			irA = "/Convocatoria/AdmCompromisos.jsp";
			if (convocatoriasDB.modificaCompromiso((ConvocatoriaOBJ) sesion
					.getAttribute("convocatoriaOBJ")))
				mensaje = "Documento Actualizado Correctamente";
			else
				mensaje = "El Documento no pude ser actualizado";
		...
		case ParametrosOBJ.ModificarCrit:
			irA = "/Convocatoria/AdmCritAsp.jsp";
			if (convocatoriasDB.modificaCriterio((ConvocatoriaOBJ) sesion
					.getAttribute("convocatoriaOBJ")))
		...
		case ParametrosOBJ.ModificarAsp:
			irA = "/Convocatoria/AdmCritAsp.jsp";
			if (convocatoriasDB.modificaAspecto((ConvocatoriaOBJ) sesion
					.getAttribute("convocatoriaOBJ")))
		...
		case ParametrosOBJ.ModificarEje:
			irA = "/Convocatoria/AdmEjes.jsp";
			if (convocatoriasDB.modificaEje((ConvocatoriaOBJ) sesion
					.getAttribute("convocatoriaOBJ")))
				mensaje = "Documento Actualizado Correctamente";
			else
				mensaje = "El Documento no pude ser actualizado";
	...
	void buscar(HttpServletRequest req, HttpServletResponse resp,
			HttpSession sesion, Usuario usuario, ConvocatoriasDB convocatoriasDB)
			throws ServletException, IOException {
		ConvocatoriaOBJ datReq = convocatoriasDB.getRequisito(Integer
				.parseInt("" + req.getParameter("reqId")));
		if (datReq != null) {
			req.setAttribute("convocatoriaOBJ", datReq);
		}
	}

	void buscarRubro(HttpServletRequest req, HttpServletResponse resp,
			HttpSession sesion, Usuario usuario, ConvocatoriasDB convocatoriasDB)
			throws ServletException, IOException {
		ConvocatoriaOBJ datRub = convocatoriasDB.getRubro(Integer.parseInt(""
				+ req.getParameter("rubId")));
		if (datRub != null) {
			req.setAttribute("convocatoriaOBJ", datRub);
		}
	}

	void buscarCompromiso(HttpServletRequest req, HttpServletResponse resp,
			HttpSession sesion, Usuario usuario, ConvocatoriasDB convocatoriasDB)
			throws ServletException, IOException {
		ConvocatoriaOBJ datCom = convocatoriasDB.getCompromiso(Integer
				.parseInt("" + req.getParameter("comId")));
		if (datCom != null) {
			req.setAttribute("convocatoriaOBJ", datCom);
		}
	}

	void buscarCriterio(HttpServletRequest req, HttpServletResponse resp,
			HttpSession sesion, Usuario usuario, ConvocatoriasDB convocatoriasDB)
			throws ServletException, IOException {
		ConvocatoriaOBJ datCrit = convocatoriasDB.getCriterio(Integer
				.parseInt("" + req.getParameter("critId")));
		if (datCrit != null) {
			req.setAttribute("convocatoriaOBJ", datCrit);
		}
	}

	void buscarAspecto(HttpServletRequest req, HttpServletResponse resp,
			HttpSession sesion, Usuario usuario, ConvocatoriasDB convocatoriasDB)
			throws ServletException, IOException {
		ConvocatoriaOBJ datAsp = convocatoriasDB.getAspecto(Integer.parseInt(""
				+ req.getParameter("aspId")));
		if (datAsp != null) {
			req.setAttribute("convocatoriaOBJ", datAsp);
		}
	}

	void buscarEje(HttpServletRequest req, HttpServletResponse resp,
			HttpSession sesion, Usuario usuario, ConvocatoriasDB convocatoriasDB)
			throws ServletException, IOException {
		ConvocatoriaOBJ datEje = convocatoriasDB.getEje(Integer.parseInt(""
				+ req.getParameter("ejeId")));
		if (datEje != null) {
