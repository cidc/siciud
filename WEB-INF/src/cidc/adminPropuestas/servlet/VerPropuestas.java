...
public class VerPropuestas extends ServletGeneral {
	...
	public String[] operaciones(HttpServletRequest req, HttpServletResponse resp)
		...
		case 1:
			sesion.setAttribute(
					"listaPropOBJ",
					adminPropuestaDB.getTodasPropuestas(
			...
			sesion.setAttribute(
					"listaPropApOBJ",
					adminPropuestaDB.getPropuestasAp(
							Integer.parseInt(req.getParameter("ano")),
							Integer.parseInt(req.getParameter("num"))));
			req.setAttribute(
					"convEstado",
		...
		case 2:
			if (sesion.getAttribute("propuestaOBJ") != null) {
				adminPropuestaDB.borrar(Integer.parseInt(req
						.getParameter("convId")));
				if (adminPropuestaDB.AproboRequisitos((PropuestaOBJ) sesion
						.getAttribute("propuestaOBJ")))
